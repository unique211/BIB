...

{
...

    {
        ...
        foreach ($list as $invoices) {
            ...
            if ($this->aauth->get_user()->roleid == 2 ||$this->aauth->get_user()->roleid == 3) {//change by sagar--01-01-2020
...

    {
        ...
        $data['employee'] = $this->invocies->employee($data['invoice']['salesperson_id']);
