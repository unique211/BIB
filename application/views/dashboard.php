                            ...
                            <div class="card-block">
                                <div class="media">
                                    ...
                                    <div class="media-body media-middle">
                                        <span><h3><?php echo $this->lang->line('Total') .' '. $this->lang->line('not_shipped') ?></h3></span>
                                    </div>
                                    <div class="media-right media-middle" style="width:30%;">
                                        <h3 class="deep-orange"> <?php echo $notShipped ?> </h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="card-block">
                                <div class="media">
                                    ...
                                    <div class="media-body media-middle">
                                        <span><h3><?php echo $this->lang->line('Total') .' '.  $this->lang->line('sales') ?></h3></span>
                                    </div>
                                    <div class="media-right media-middle" style="width:30%;">
                                        <h3 class="deep-orange"><?php echo amountFormat($totalsales) ?> </h3>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--  last 10 entry from current date  -->
<div class="row"> 
   ...
   <div class="card-header ">
              <h4 class="card-title">Last 10 Shows:</h4>

          </div>
          <div class="card-body">
          <div class="table-responsive">
      <table id="showtable1" class="table table-hover" cellspacing="0" width="100%">
...
<div class="card">
   <div class="card-header ">
              <h4 class="card-title">Next 10 Shows:</h4>

          </div>
          <div class="card-body">
          <div class="table-responsive">
<table id="showtable2" class="table table-hover" cellspacing="0" width="100%">
       ...
       <!--     <div class="row">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    ...
                    <a href="<?php echo base_url(); ?>employee"><div class="card">
                        <div class="card-body">
                            <div class="media">
                                <div class="p-1 text-xs-center bg-green media-left media-middle">
                                    <i class="icon-users font-large-2 white"></i>
                                </div>
                                <div class="p-1 media-body">
                                    <h5 class="green"> <?php echo $this->lang->line('Employees') ?></h5>
...
url  :"<?php echo site_url('projects/show_load_list1')?>",
...
success : function(data){
   ...
   for(i=0; i<data.length; i++){
    var status='';
    if(data[i][2] == 'Pending'){
        status='<span class="project_Pending">'+data[i][2]+'</span>';
    }else if(data[i][2] == 'Finished'){
        status='<span class="project_Finished">'+data[i][2]+'</span>';
    }else if(data[i][2] == 'Waiting'){
        status='<span class="project_Waiting">'+data[i][2]+'</span>';
    }
    ...
    html += '<tr>'+
          ...
          '<td><a href="<?php echo site_url('projects/exploreshow');?>?id='+data[i][0]+'" class="btn btn-primary btn-sm rounded" data-id="'+data[i][0]+'" data-stat="0"> <i class="icon-eye"></i>  </a></td>'+

            '</tr>';
   }
   $('#showtable1_details').html(html);
...
$.ajax({
    ...
    url  :"<?php echo site_url('projects/show_load_list2')?>",
    ...
    html += '<tr>'+
            ...
            '<td>'+data[i].show_id+'</td>'+//change by sagar
