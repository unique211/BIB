            ...
            <div class="card card-block">
                ...
                <form method="post" id="data_form">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                <div class="form-group row">
                                    <div class="fcol-sm-12">
                                        <h3 class="title">
                                            <?php echo $this->lang->line('Bill To') ?> <a href='#' <?php echo $this->lang->line('Add Client') ?>
                                            </a>
                                    </div>
                                </div>
                    ...
                    <label class="col-sm-4 col-form-label"
                           for="product_catname">Shipping - Options</label>

                    <fieldset>
                        <div class="col-sm-8">
                            <input  type="radio" style="margin-top: 10px"  name="project_type1" value="Self-pickup"  />
                            <label for="Self-pickup">Self-pickup</label>
                            <input type="radio" style="margin-left: 17px" checked="checked"  name="project_type1" value="To Be Shipped"   />
                            <label for="To Be Shipped">To Be Shipped</label>
                        </div>
                    </fieldset>
                </div>
                                <div id="customer">
