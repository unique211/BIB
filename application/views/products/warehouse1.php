<article class="content">
    <div class="card card-block">
        ...
        <div class="grid_3 grid_4 table-responsive animated fadeInRight">
            <h3 class="title"> <?php echo $this->lang->line('Warehouses') ?> 
            <?php if($this->aauth->get_user()->roleid != 3 ){ ?><!-- change by sagar 06-01-2020---><a
