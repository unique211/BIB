<article class="content">
    <div class="card card-block">
        ...
        <div class="grid_3 grid_4 table-responsive animated fadeInRight">
            <h3 class="title"> <?php echo $this->lang->line('Product Category') ?>
<?php if($this->aauth->get_user()->roleid != 3 ){ ?><!-- change by sagar 06-01-2020--->
            <a
            ...
            <table id="catgtable" class="display" cellspacing="0" width="100%">
                ...
                foreach ($cat as $row) {
                    ...
                    if($this->aauth->get_user()->roleid == 3){
                        echo "<td><a href='" . base_url("productcategory/view?id=$cid") . "' class='btn btn-success btn-xs'><i class='icon-file-text'></i> " . $this->lang->line('View') . "</a>&nbsp;</td></tr>";
                    }else{
