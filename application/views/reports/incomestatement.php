<article class="content">
    ...
    <div class="card card-block">
        ...
        <div class="grid_3 grid_4">
            <h6><?php echo $this->lang->line('Income Statement') ?></h6>
            <hr>
            ...
            <div class="row sameheight-container">
                <div class="col-md-6">
                    <div class="card card-block sameheight-item">
                        ...
                        <p><?php echo $this->lang->line('Total Income') ?><?php echo amountFormat($income['lastbal']) ?></p>
                        <p><?php echo $this->lang->line('This Month Income') ?><?php echo amountFormat($income['monthinc']) ?></p>
                        <p id="param1"></p>
                        <p id="param2"></p>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control required"
                                   placeholder="Start Date" name="sdate" id="s_date"
                                    autocomplete="false">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control required"
                                   placeholder="End Date" name="edate" id="e_date"
                                    autocomplete="false">
                        </div>
                    </div>
