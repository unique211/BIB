...
<div class="app-content content container-fluid">
    ...
    <div class="content-wrapper">
                        ...
                        <div class="card-block">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" id="reports1-tab" data-toggle="tab" href="#reports1" aria-controls="reports">Reports</a>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Are you sure you want to Accept This Team Leader for <?php echo $project['show_name']; ?> ? </p>

                        </div>

                        <div class="modal-footer">

                            <input type="hidden" id="object-id_11" value="" name="object_id">

                            <input type="hidden" id="action-url_11" value="projects/accept_request_show">

                            <button type="button" data-dismiss="modal" class="btn btn-primary delete-confirm" id="delete-confirm_11">Accept</button>
        ...
        <!-- 12 Reject Team Leader-->

        <div id="delete_model_12" class="modal fade">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Are you sure want to Reject request of This Team Leader for <?php echo $project['show_name']; ?> ? </p>

                        </div>

                        <div class="modal-footer">

                            <input type="hidden" id="object-id_12" value="" name="object_id">

                            <input type="hidden" id="action-url_12" value="projects/reject_request">

                            <button type="button" data-dismiss="modal" class="btn btn-danger delete-confirm" id="delete-confirm_12">Reject</button>
        ...
        <!-- transfer confirmation for manually  -->

        <div id="transfer_confirmation_model" class="modal fade">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Are you sure want to transfer this products ? </p>

                    </div>

                    <div class="modal-footer">

                        <button type="button" data-dismiss="modal" class="btn btn-danger" id="Transfer_product_manually">Transfer</button>
    ...
    <!-- Bo Inventory History Model -->

    <div id="task1_model" class="modal fade" role="dialog">

        <div class="model-width" style="margin-left: 10%;margin-top: 10%;">
                ...
                <div>
                    ...
                    <table class="table table-responsive">
                        ...
                        <thead>
                            ...
                            <th class="priority-3">Requested Quantity</th>

                            <th class="priority-5">Requasted At</th>

                            <th class="priority-4">Approved Quantity</th>

                            <th class="priority-6">Approved At</th>

                            <th class="priority-7">Recieved At</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="priority-2">Queen Pillow 1</td>

                                <td class="priority-3">23</td>

                                <td class="priority-5">2019-05-15 00:10:45</td>

                                <td class="priority-4">10</td>

                                <td class="priority-6">2019-05-15 00:10:45</td>

                                <td class="priority-7">2019-05-15 00:10:45</td>

                                <td class="priority-9"></td>
                            ...
                            <tr>
                                ...
                                <td class="priority-2">Queen Pillow 2</td>

                                <td class="priority-3">20</td>
                                ...
                                <td class="priority-7">-</td>

                                <td class="priority-9"><a href="" class="btn btn-success btn-sm rounded" data-id="" data-stat="0">Confirm</a></td>
                            ...
                            <tr>
                                ...
                                <td class="priority-2">Queen Pillow 3</td>

                                <td class="priority-3">20</td>

                                <td class="priority-4">2019-05-15 00:10:45</td>

                                <td class="priority-5"><input type="number" class="form-control" min="0" value="0" /></td>

                                <td class="priority-6">-</td>

                                <td class="priority-7">-</td>

                                <td class="priority-9"><a href="" class="btn btn-primary btn-sm rounded" data-id="" data-stat="0">Approve</a></td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table id="todotableee" class="display" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="row"><?php echo $this->lang->line('Total Sales per day') ?></td>
        ...
        $(document).ready(function() {
            ...
            $('#attendeestable').DataTable({
                ...
                "ajax": {
                    ...
                    "url": "<?php echo site_url('projects/attendees_list?id=' . $_GET['id']) ?>"
                },
                "columnDefs": [
            ...
            $('#approveTeamLeadertable').DataTable({
                ...
                "ajax": "<?php echo site_url('projects/req_show?id=' . $_GET['id']) ?>",
                "oLanguage": {
            ...
            $('#todotable').DataTable({
                ...
                "ajax": "<?php echo site_url('/projects/showtodo_load_list?id=' . $_GET['id']) ?>",
                "oLanguage": {
                    "sEmptyTable": "There is no Data available"
                },
                'createdRow': function(row, data, dataIndex) {
            ...
            $('#tlsidepackhist').DataTable({

                "ajax": "<?php echo site_url('/projects/gethistorydetailstl?id=' . $_GET['id']) ?>",
                "oLanguage": {
                    "sEmptyTable": "There is no Data available"
                },
            ...
            $('#tlrequestforpackinglist').DataTable({
                "ajax": "<?php echo site_url('/projects/gettlrequestforpackinglist?id=' . $_GET['id']) ?>",
                'createdRow': function(row, data, dataIndex) {
            ...
            $('#confirmpackinglisttl').DataTable({
                "ajax": "<?php echo site_url('/projects/getpackinglistrequestforconfirm?id=' . $_GET['id']) ?>",
                'createdRow': function(row, data, dataIndex) {
                    $(row).attr('data-block', '0');
                },
                "oLanguage": {
            ...
            $('#requesthistory').DataTable({
                "ajax": "<?php echo site_url('/projects/gethistorydetailsbo?id=' . $_GET['id']) ?>",
                "oLanguage": {
                    "sEmptyTable": "There is no Data available"
                },
            ...
            $('#salesperson_reqest_list').DataTable({

                "ajax": "<?php echo site_url('/projects/salesperson_request_list_for_tl?id=' . $_GET['id']) ?>",
                'createdRow': function(row, data, dataIndex) {
                    $(row).attr('data-block', '0');
                },
                "oLanguage": {
            ...
            $('#stock_history_teamleader').DataTable({

                "ajax": "<?php echo site_url('/projects/stock_transfer_history_list?id=' . $_GET['id']) ?>",
                "oLanguage": {
                    "sEmptyTable": "There is no Data available"
                },
            ...
            $(document).on('click', ".view_task", function(e) {
                ...
                var actionurl = 'tools/view_task_show';
            ...
            //---------------------------------------------view history of packing list for Bo-----
            ...
            $(document).on('click', ".view_history", function(e) {
                ...
                var actionurl = 'projects/view_history_packinglist';
                ...
                console.log('Modal Data is : ' + baseurl + " " + actionurl + " | requested at :  " + id);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        console.log(data);
                        var t = $('#historymodeltable').DataTable();
                        t.clear();

                        for (var j = 0; j < data.length; j++) {
                            t.row.add([data[j].no, data[j].product_name, data[j].product_requested_qty, data[j].product_approved_qty, data[j].product_requested_at, data[j].product_approved_at, data[j].product_received_at, data[j].action]).draw(false);
                        }

                        console.log("result is : " + data.length);
            ...
            //---------------------------------------------view history of packing list for team leader -----

            $(document).on('click', ".view_history1", function(e) {



                e.preventDefault();

                var actionurl = 'projects/view_history_packinglist_tl';
    ...
    <script>
        ...
        $(function() {
            ...
            var url = baseurl + 'projects/file_show_handling?id=<?php echo $project['id']; ?>',
        ...
        $('.ckqty').change(function() {
            var id = $(this).attr('id');
            var qty = $('#' + id).val();

            $.ajax({

                url: baseurl + 'projects/checkqty',
                ...
                success: function(data) {
                    if (data == 'fail') {
                        ...
                        alert(qty + ' Number of quantity is not available for this product');
                        $('#' + id).val(0);
    ...
    <script type="text/javascript">
        $(".disablefield :input").attr("disabled", true);
    </script>

    <script>
        $(document).on('click', ".display-consignment-details", function(e) {

            e.preventDefault();

            var show_id = $(this).attr('show_id');
            var teamleader_id = $(this).attr('teamleader_id');



            window.location.href = baseurl + "BiB/reports/consignmentlist?sid=" + show_id + "&tid=" + teamleader_id;
    ...
    <script type="text/javascript">
        $('.delete-break-time').click(function() {

            $("#notify .message").html();

            var show_id = $(this).attr('show_id');
            var salesperson_id = $(this).attr('salesperson_id');

            jQuery.ajax({

                url: baseurl + "projects/deletebreaktime_show",
        ...
        //get the amount for salesperson for this project
        $('#salesperson').on("change", function() {
            var show_id  = "<?php echo $project['location_id'];?>";
            var salesperson_id  = $(this).val();
            console.log(show_id +' '+salesperson_id);
            $.ajax({

                url: baseurl + "projects/getSalesPersonAmount",
        ...
        $('#uploadFile').ajaxfileupload({
            ...
            'action': baseurl + 'Projects/doc_image_upload',
            ...
            'onComplete': function(response) {
                ...
                if (response == '') {
                    ...
                    var img = $('<img />').addClass('img').attr({
                        ...
                        'src': baseurl + 'assets/booth_img/' + $.trim(response[1]),
