                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-block">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" id="location-tab" data-toggle="tab" href="#location"
                                       aria-controls="location"><?php echo $this->lang->line('Location') ?></a>
                                </li>
                                <?php if ($this->aauth->get_user()->roleid== 5) { ?>
                                    <li class="nav-item">
                                        <a class="nav-link" id="booths-tab" data-toggle="tab" href="#booths"
                                           aria-controls="booths"><?php echo $this->lang->line('Booth') ?></a>
                                    </li>

                                 <?php } ?>

                                 <li class="nav-item">
                                    <a class="nav-link" id="communication-tab" data-toggle="tab" href="#communication"
                                       aria-controls="communication"><?php echo $this->lang->line('Communication') ?></a>
                                </li>

                                 <?php if ($this->aauth->get_user()->roleid== 5) { ?>
                                 <li class="nav-item">
                                    <a class="nav-link" id="teamleader-tab" data-toggle="tab" href="#teamleader"
                                       aria-controls="teamleader"><?php echo $this->lang->line('Team Leader') ?></a>
                                </li>
                            <?php } ?>
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" id="salesperson1-tab" data-toggle="tab" href="#salesperson1"
                                       aria-controls="salesperson1"><?php echo $this->lang->line('Break timings') ?></a>
                                </li>
                                  <li class="nav-item">
                                    <a class="nav-link" id="packinglist-tab" data-toggle="tab" href="#packinglist"
                                       aria-controls="packinglist"><?php echo $this->lang->line('Packing List') ?></a>
                                </li>
                                 <li class="nav-item">
                            ...
                            <?php } ?>
                             <li class="nav-item">
                                    <a class="nav-link" id="Attendees-tab" data-toggle="tab" href="#Attendees"
                                       aria-controls="Attendees"><?php echo $this->lang->line('Attendees') ?></a>
                                </li>
                            ...
                            <div class="tab-content px-1 pt-1">
                                ...
                                <div role="tabpanel" class="tab-pane fade " id="Attendees"
                                     aria-labelledby="Attendees-tab" aria-expanded="true">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <ul class="nav nav-tabs nav-justified">
                                                   ...
                                                   <li class="nav-item">
                                                    ...
                                                    <li class="nav-item"> <a class="nav-link" id="link-tab" data-toggle="tab" href="#link"
                                ...
                                <div class="tab-pane fade" id="link" role="tabpanel" aria-labelledby="link-tab" aria-expanded="false">
                                    <p><a href="<?php echo base_url('projects/addtask?id=' . $project['id']) ?>"
                                                class="btn btn-primary btn-sm rounded">
                        ...
                        <textarea class="summernote"
                                ...
                                <!--comments-->
                                <!-- BOOTH -->
                                <div class="tab-pane fade" id="booths" role="tabpanel" aria-labelledby="booths-tab"
                                     aria-expanded="false">
                                    <p><a href="<?php echo base_url('index.php/projects/addbooth?id=' . $project['id']) ?>"
                                                class="btn btn-primary btn-sm rounded">
                                ...
                                <!-- PACKING LIST -->
                                <div class="tab-pane fade" id="packinglist" role="tabpanel" aria-labelledby="packinglist-tab"
                                     aria-expanded="false">
                                    <!--  <p>
                                        <a
                                                href="#"
                                        ...
                                        <div class="col-md-4">
                                            <table cellspacing="0" class="table table-bordered" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>King Pillow</td>
                                                         <td><input type="number" style="width: 50px" <?php if ($this->aauth->get_user()->roleid== 5) { ?> disabled="true" <?php } ?> value="20"/></td> <td><input type="number" style="width: 50px" <?php if ($this->aauth->get_user()->roleid== 3) { ?> disabled="true" <?php } ?> value="20"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Queen Pillow</td>
                                                         <td><input type="number" style="width: 50px" <?php if ($this->aauth->get_user()->roleid== 5) { ?> disabled="true" <?php } ?> value="20"/></td> <td><input type="number" style="width: 50px" <?php if ($this->aauth->get_user()->roleid== 3) { ?> disabled="true" <?php } ?> value="20"/></td>
                                ...
                                <!-- SALES PERSON -->
                                 ...
                                 <div class="tab-pane fade" id="salesperson1" role="tabpanel" aria-labelledby="salesperson1-tab"
                                     aria-expanded="false">
                                    <p><a href="SetBreakTime"
                                                class="btn btn-primary btn-sm rounded">
                                     ...
                                     <div class="grid_3 grid_4">
                                            ...
                                            <form method="post" id="data_form" class="form-horizontal">
                                             ...
                                             <hr>
                                               ...
                                               for="contact_person"><b>Contact Person </b></label>
                                               <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label"
                                               for="contact_number"><b>Contact Number </b></label>
                                               <div class="col-sm-6">
                                             ...
                                             <div class="form-group row">
                                                <label class="col-sm-2 col-form-label"
                                               for="extension"><b>Extension (if any)</b></label>
                                               <div class="col-sm-6">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <label class="col-sm-2 col-form-label"
                                               for="indoor_outdoor"><b><?php echo $this->lang->line('Indoor') ?>/<?php echo $this->lang->line('Outdoor') ?></b></label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label"
                                               for="address"><b><?php echo $this->lang->line('Address') ?></b></label>
                                               <div class="col-sm-6">
