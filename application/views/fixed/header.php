...
<head>
    ...
    <script>
	$(".alert a:contains('activate')").parent().remove();
        //alert('hi');
       var tokenvalue='';
        // Initialize Firebase
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown"
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="dropdown-menu-header">
                                ...
                                <h6 class="dropdown-header m-0"><span class="grey darken-2"><?php echo $this->lang->line('Show Request') ?></span>
                                </h6>
                            </li>

                            <li class="list-group scrollable-container" id="showrequestlist"></li>
                            <?php } ?>
                             <!-- show request  end -->
                             <!-- pending  request  start -->
                            <li class="dropdown-menu-header inreq">

                                <h6 class="dropdown-header m-0"><span class="grey darken-2"><?php echo $this->lang->line('Pending Inventory Request') ?></span>
                                </h6>
                            </li>

                            <li class="list-group scrollable-container inreq" id="pendinginvrequestlist"></li>
                            <!-- pending request end -->
                            <!-- Inventory Allocated start -->
                            <li class="dropdown-menu-header inalloc">

                                <h6 class="dropdown-header m-0"><span

                                            class="grey darken-2"><?php echo $this->lang->line('Inventory Allocated') ?></span>
                                </h6>

                            </li>

                            <li class="list-group scrollable-container inalloc" id="invallocatedlist"></li>

                           
                            <!-- Inventory Allocated end -->
                            <!-- Inventory Confirm start -->
                            <li class="dropdown-menu-header inconfirm">

                                <h6 class="dropdown-header m-0"><span

                                            class="grey darken-2"><?php echo $this->lang->line('Inventory Confirmed') ?></span>
                                </h6>

                            </li>

                            <li class="list-group scrollable-container inconfirm" id="invconfirmlist"></li>

                           
                            <!-- Inventory Confirm end -->
                            <!-- break time start  -->
                            <!-- <li class="dropdown-menu-header">

                                <h6 class="dropdown-header m-0"><span

                                            class="grey darken-2"><?php echo $this->lang->line('Break Timing') ?></span>

                                </h6>

                            </li>

                            <li class="list-group scrollable-container" id="breaktimelist"></li> -->

                            
                           
                            <!-- break time end  -->
                            <!-- pending task start -->
                            <li class="dropdown-menu-header ptask">
                            ...
                            <li class="list-group scrollable-container ptask" id="tasklist"></li>

                            <li class="dropdown-menu-footer ptask"><a href="<?php echo base_url('manager/todo') ?>"
                ...
                <li class="nav-item has-sub sidebar-green-backgrod <?php if ($this->uri->segment(1) == "products") {
                    ...
                    <ul class="menu-content sidebar-green-backgrod">
                        ...
                        <li class="sidebar-green-backgrod">
                            ...
                            <a href="<?php echo base_url(); ?>productcategory/productmaterial"><?php echo $this->lang->line('material') ?></a>
                        </li>
                        <li class="sidebar-green-backgrod">
...
-->
			...
			<li class="navigation-header sidebar-green-backgrod"><span>Reps</span><i
				...
				<li class="sidebar-green-backgrod"><a href="<?php echo base_url(); ?>employee"><i class="icon-users"></i><span
                                ...
                                class="menu-title"> All Reps</span></a>
                    ...
                    <ul class="menu-content sidebar-green-backgrod">
                        ...
                        <li class="sidebar-green-backgrod">
                         ...
                         <li class="sidebar-green-backgrod">
                            ...
                            <a href="<?php echo base_url(); ?>reports/item_report">Item Reports</a>
