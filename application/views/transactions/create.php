<article class="content">
    ...
    <div class="card card-block">
        ...
        <form method="post" id="data_form_transaction" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="grid_3 grid_4">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                        ...
                        <label class="col-sm-2 control-label"
                               ...
                               for="file">Attach a file</label>


                               
                        <div class="col-sm-4">

                            <input type="file" id="transaction_file" class="form-control required"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="submit" id="submit-data-transaction" class="btn btn-success margin-bottom"
