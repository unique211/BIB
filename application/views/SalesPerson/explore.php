...
?>
                                ...
                                <div class="card-block">
                                    ...
                                    <ul class="nav nav-tabs nav-justified">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" id="inventory1-tab" data-toggle="tab" href="#inventory1"

                                               aria-controls="inventory1"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <li class="nav-item">
                                                            ...
                                                            <a class="nav-link" id="salses_packinglist-tab" data-toggle="tab" href="#salses_packinglist"

                                                                       aria-controls="salses_packinglist">Requested Requisition List </a>
                                                        ...
                                                        <div class="tab-content px-1 pt-1">
                                                             ...
                                                             <div class="tab-pane fade active in " id="packinglistrequest" role="tabpanel" aria-labelledby="packinglistrequest-tab"
   ...
   <div class="row">
    ...
    <div class="row">
        ...
        <div class="tab-pane fade " id="salses_packinglist" role="tabpanel" aria-labelledby="salses_packinglist-tab"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" data-dismiss="modal" class="btn btn-primary delete-confirm"
                                    ...
                                    id="delete-confirm_38">Confirm</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" data-dismiss="modal" class="btn btn-primary delete-confirm"
                                    ...
                                    id="delete-confirm_63">Confirm</button>
