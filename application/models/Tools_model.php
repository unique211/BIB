...

{
    ...
    public function setshowtask($id, $stat)

    {


        $data = array('showtaskstatus' => $stat);
    ...
    //Delete Show todo List (Task )

    public function deleteshowtask($id)

    {



        return $this->db->delete('showtodolist', array('id' => $id));
    ...
    public function viewtaskshow($id)
    {
         $this->db->select('showtodolist.*,employee_profile.name AS emp,assi.name AS assign');
         $this->db->from('showtodolist');
         $this->db->where('showtodolist.id', $id);
         $this->db->join('employee_profile', 'employee_profile.id = showtodolist.showtaskeid', 'left');
         $this->db->join('employee_profile AS assi', 'assi.id = showtodolist.showtaskaid', 'left');
         $query = $this->db->get();
        return $query->row_array();
